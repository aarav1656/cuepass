...
- **Letter-spacing has two registers**: positive (0.72–1.9px) for ALL-CAPS mono and sans labels, negative (`-0.16px`) for the rare serif appearances, slightly positive (0.32px, 1.07px) for massive display. Plain 0 letter-spacing is rare.
...
### Inputs & Forms
- **Default**: `#131313` background, 1px solid `#ffffff` or `#949494` border, `2px` border radius (tight, newspaper-form feel), PolySans 15px text in `#ffffff`, prompt text in `#949494`.
...
| 1 | `rgba(0,0,0,0) 0px 0px 0px 0px inset` (no-op shadow) | Reset state for interactive elements |
